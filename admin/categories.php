			...
			<form action="" id="manage-category">
				<div class="card">
					...
					<div class="card-body">
							...
							<div class="form-group">
								<img src="<?php echo isset($image_path) ? '../images/'.$cover_img :'' ?>" alt="" id="cimg">
							</div>
					</div>
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center">
										<img src="<?php echo isset($row['cover_img']) ? '../images/'.$row['cover_img'] :'' ?>" alt="" id="cimg">
									</td>
									<td class="">
...
<script>
	...
	$('.edit_cat').click(function(){
		...
		cat.find("#cimg").attr('src','../images/'+$(this).attr('data-cover_img'))
		end_load()
	})
